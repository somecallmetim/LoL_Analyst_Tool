...
public class BackgroundMapPanel extends JPanel
{
     ...
     */
    public BackgroundMapPanel(Image image)
    {
        this(image, SCALED);
    }
     ...
     */
    public BackgroundMapPanel(Image image, int style)
    {
        setImage( image );
        setStyle( style );
     ...
     */
    public BackgroundMapPanel(Image image, int style, float alignmentX, float alignmentY)
    {
        setImage( image );
        setStyle( style );
     ...
     */
    public BackgroundMapPanel(Paint painter)
    {
        setPaint( painter );
        setLayout( new BorderLayout() );
    }
